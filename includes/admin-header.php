    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="dashboard.php">
                <img src="../assets/img/logo.svg" alt="Logo" width="30" height="30" class="d-inline-block align-text-top me-2">
                Admin Panel
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="auctions.php"><i class="fas fa-gavel me-1"></i> Auctions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="bids.php"><i class="fas fa-money-bill-wave me-1"></i> Bids</a>
                    </li>
                    <li class="nav-item">
